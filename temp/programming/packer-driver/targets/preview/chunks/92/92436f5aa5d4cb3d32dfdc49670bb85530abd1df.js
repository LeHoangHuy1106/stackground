  ...
  return {
    ...
    execute: function () {
      ...
      _export("MainScene", MainScene = (_dec = ccclass('MainScene'), _dec2 = property(Label), _dec(_class = (_class2 = class MainScene extends Component {
        ...
        onLoad() {
          var highScore = parseInt(sys.localStorage.getItem((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).highScore)) || 0;
          var score = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
...
//# sourceMappingURL=92436f5aa5d4cb3d32dfdc49670bb85530abd1df.js.map