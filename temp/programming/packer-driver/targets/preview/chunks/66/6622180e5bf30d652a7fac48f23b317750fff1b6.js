    ...
    execute: function () {
      ...
      _export("NodeCustom", NodeCustom = (_dec = ccclass('NodeCustom'), _dec(_class = class NodeCustom extends Component {
        ...
        SetSize(sizeX) {
          ...
          var newColliderSize = new Rect(0, 0, sizeX, this.GetSize().y); // Gán kích thước mới cho collider2D
        ...
        HorizontalScrolling(deltaTime) {
          var newPositionX = this.node.position.x + this.speed * this.direction * deltaTime;
...
//# sourceMappingURL=6622180e5bf30d652a7fac48f23b317750fff1b6.js.map